...
//        });
    ...
    /**
     * Changes the text of the selected button to blue
     */
    ...
    /**
     * Helper method to add a question to database
     * @param deckName question deck name
     * @param questionName name of question
     * @param questionText the text of the question
     * @param vars variables string
     * @param expressions expressions string
     * @param answer answer string
     * @param precision precision of answer
     */
